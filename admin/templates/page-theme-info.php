 ...
 * @subpackage Babita_Business_Theme/Babita_Business_Theme_Intro
 */
		...
		<div class="welcome-panel-content">
			<div class="welcome-panel-header">
				...
				<p>
					...
					if ( ! Babita_Business_Theme_is_pro_active() ) {
						echo ' ';
		...
		<div class="at-row at-m companydomain-wbtb-main-wrp">
							...
							<div class="companydomain-wbtb-intro-auth at-p">
								<div class="companydomain-wbtb-intro-profile at-h at-w at-bdr at-bdr-rad at-m at-flx at-al-itm-ctr at-jfy-cont-ctr">
									<span class="at-w at-h at-bdr-rad">
										<img class="companydomain-wbtb-gsm-screenshot" src="<?php echo esc_url( BABITA_BUSINESS_THEME_URL . 'assets/img/patternswp-logo.png' ); ?>" alt="<?php esc_attr_e( 'WP Block Theme Boilerplate', 'wp-block-theme-boilerplate' ); ?>" />
									</span>
								</div>
			...
			<div class="at-col-sm-9 at-col-md-7 at-col-lg-8 at-col-xl-9">
				<div class="companydomain-wbtb-main-cont at-flx at-flx-col at-gap">
					...
					<div class="at-row at-gap">
						<?php
						$recommended_plugins = function_exists( 'Babita_Business_Theme_get_recommended_plugins' ) ? Babita_Business_Theme_get_recommended_plugins() : null;
								...
								<div class="companydomain-wbtb-card-body at-p at-flx at-flx-col at-gap">
									...
									foreach ( $recommended_plugins as $key => $plugin_info ) {
										...
										<div class="at-flx at-jfy-cont-btw at-al-itm-ctr companydomain-wbtb-plugin-recommend">
											...
											<?php
											if ( Babita_Business_Theme_is_plugin_active( $plugin_info['plugin'] ) ) {
												?>
							...
							<div class="companydomain-wbtb-card at-bg-cl at-bdr">
								...
								<div class="companydomain-wbtb-card-body at-p">
									<div class="companydomain-wbtb-card-btn-grp at-flx at-flx-wrp at-gap">
										<a class="companydomain-wbtb-btn companydomain-wbtb-btn-primary-outline button button-hero" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template_part&postId=' . BABITA_BUSINESS_THEME_NAME . '%2F%2Fheader&canvas=edit' ) ); ?>">
											<?php esc_html_e( 'Edit Header', 'wp-block-theme-boilerplate' ); ?>
										</a>
										<a class="companydomain-wbtb-btn companydomain-wbtb-btn-primary-outline button button-hero" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template_part&postId=' . BABITA_BUSINESS_THEME_NAME . '%2F%2Ffooter&canvas=edit' ) ); ?>">
											<?php esc_html_e( 'Edit Footer', 'wp-block-theme-boilerplate' ); ?>
										</a>
										<a class="companydomain-wbtb-btn companydomain-wbtb-btn-primary-outline button button-hero" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template_part&postId=' . BABITA_BUSINESS_THEME_NAME . '%2F%2Fprimary-sidebar&canvas=edit' ) ); ?>">
											<?php esc_html_e( 'Edit Primary Sidebar', 'wp-block-theme-boilerplate' ); ?>
										</a>
										<a class="companydomain-wbtb-btn companydomain-wbtb-btn-primary-outline button button-hero" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template_part&postId=' . BABITA_BUSINESS_THEME_NAME . '%2F%2Fsecondary-sidebar&canvas=edit' ) ); ?>">
										...
										<a class="companydomain-wbtb-btn companydomain-wbtb-btn-primary-outline button button-hero" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template&postId=' . BABITA_BUSINESS_THEME_NAME . '%2F%2Ffront-page&canvas=edit' ) ); ?>">
											<?php esc_html_e( 'Edit Frontpage', 'wp-block-theme-boilerplate' ); ?>
										</a>
										<a class="companydomain-wbtb-btn companydomain-wbtb-btn-primary-outline button button-hero" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template&postId=' . BABITA_BUSINESS_THEME_NAME . '%2F%2Farchive&canvas=edit' ) ); ?>">
					...
					<?php
					$faqs = function_exists( 'Babita_Business_Theme_get_theme_faq' ) ? Babita_Business_Theme_get_theme_faq() : null;
					if ( $faqs ) {
						?>
							<div class="at-row">
								<div class="at-col-12">
					...
					?>
					<?php
					$changelog = function_exists( 'Babita_Business_Theme_parse_changelog' ) ? Babita_Business_Theme_parse_changelog() : '';
					if ( $changelog ) {
						?>
							<div class="at-row">
								<div class="at-col-12">
