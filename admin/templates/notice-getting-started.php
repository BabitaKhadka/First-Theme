...
<div id="companydomain-wbtb-gsn" class="updated notice-info companydomain-wbtb-gsn at-pos">
	...
	<div class="companydomain-wbtb-gsn-container at-flx at-gap at-p">
		<img class="companydomain-wbtb-gsn-screenshot at-w" src="<?php echo esc_url( BABITA_BUSINESS_THEME_URL . 'screenshot.png' ); ?>" alt="<?php esc_attr_e( 'WP Block Theme Boilerplate', 'wp-block-theme-boilerplate' ); ?>" />
		<div class="companydomain-wbtb-gsn-notice">
			<h2>
				...
				printf(
					...
					'<a href="' . esc_url( menu_page_url( BABITA_BUSINESS_THEME_NAME, false ) ) . '">',
					'</a>'
				);
				?>
			</h2>
			<?php
			$plugin_names = Babita_Business_Theme_get_plugin_names();
			if ( $plugin_names ) {
				?>
				<p>
					<?php
