...
/* global BabitaBusinessThemeLocalize */
...
class WpBlockThemeBoilerplateSettingsApi {
	constructor() {
		...
		this.nonce = BabitaBusinessThemeLocalize.nonce;
		this.getSettings();
		this.bindEvents();
	}
	...
	async installPlugins() {
		const plugins = BabitaBusinessThemeLocalize.recommended_plugins;
		...
		window.location.replace(
			BabitaBusinessThemeLocalize.theme_info_url
		);
	}
}
