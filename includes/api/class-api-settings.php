 ...
 * @subpackage Babita_Business_Theme/Babita_Business_Theme_Api_Settings
 */
 ...
 *
 * @see Babita_Business_Theme_Api
 */
if ( ! class_exists( 'Babita_Business_Theme_Api_Settings' ) ) {

	/**
	 * Babita_Business_Theme_Api_Settings
	 *
	 * @see WP_REST_Settings_Controller
	 * @package Babita_Business_Theme
	 * @since 1.0.0
	 */
	class Babita_Business_Theme_Api_Settings extends Babita_Business_Theme_Api {
		 ...
		 */
		public function run() {
			$this->type      = 'Babita_Business_Theme_api_settings';
		...
		public function get_item( $request ) {
			...
			$saved_options = Babita_Business_Theme_get_options();
		...
		public function update_item( $request ) {
			...
			if ( is_wp_error( rest_validate_value_from_schema( $params, $schema ) ) ) {
				return new WP_Error(
					...
					sprintf( __( 'The %s property has an invalid stored value, and cannot be updated to null.', 'wp-block-theme-boilerplate' ), BABITA_BUSINESS_THEME_OPTION_NAME ),
					array( 'status' => 500 )
				);
			}
			...
			/* Update options */
			Babita_Business_Theme_update_options(
				array(
			...
			/* Update user meta */
			Babita_Business_Theme_update_user_meta(
				get_current_user_id(),
				array(
		...
		public function get_settings_schema() {
			$setting_properties = apply_filters(
				'Babita_Business_Theme_options_properties',
				array(
...
/**
 * Return instance of  Babita_Business_Theme_Api_Settings class
 *
 * @since 1.0.0
 *
 * @return Babita_Business_Theme_Api_Settings
 */
function Babita_Business_Theme_api_settings() { //phpcs:ignore
	return Babita_Business_Theme_Api_Settings::get_instance();
}
Babita_Business_Theme_api_settings()->run();
